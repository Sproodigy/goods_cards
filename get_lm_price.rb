  ...
  def get_lm_product_image(product_id)
    ...
    # IO.copy_stream(open(src), "Users/extra/Изображения/Foto/Liqui_Moly_#{name}_#{get_lm_product_data(product_id)[1].first(-1)}_#{File.basename(src)}")
  end
